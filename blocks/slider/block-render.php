			...
			<div class="<?php echo esc_html( $block_name ); ?>-section-wrapper">
				<div id="splide-<?php echo esc_attr( $block_id ); ?>"
					...
					<div class="splide__arrows <?php echo esc_html( $block_name ); ?>-section-splide__arrows">
						<button class="splide__arrow <?php echo esc_html( $block_name ); ?>-section-splide__arrow splide__arrow--prev <?php echo esc_html( $block_name ); ?>-section-splide__arrow--prev animate__animated opacity-0" type="button" aria-label="<?php esc_html_e( 'Previous slide', 'gp-strategies' ); ?>"
								data-animate-class="animate__fadeIn"
						...
						<button class="splide__arrow <?php echo esc_html( $block_name ); ?>-section-splide__arrow splide__arrow--next <?php echo esc_html( $block_name ); ?>-section-splide__arrow--next animate__animated opacity-0" type="button" aria-label="<?php esc_html_e( 'Next slide', 'gp-strategies' ); ?>"
								data-animate-class="animate__fadeIn"

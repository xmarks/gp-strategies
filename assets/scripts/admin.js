 ...
 *
 * @see wp_localize_script() - The gp_strategies_dismiss_plugin_notice object containing:
 ...
 *
 * @var {object} gp_strategies_plugin_notice The localized object containing the AJAX URL and nonce.
 * @var {string} gp_strategies_plugin_notice.ajax_url The URL for making AJAX requests.
 * @var {string} gp_strategies_plugin_notice.nonce The nonce for security verification of the AJAX request.
 *
 * @package Gp_Strategies
 */
...
jQuery( document ).ready( function ( $ ) {
    ...
    $( '.st-dismiss-plugin-notice' ).on( 'click', function ( e ) {
        ...
        $.post( gp_strategies_plugin_notice.ajax_url, {
            action: 'gp_strategies_dismiss_plugin_notice', // The action triggered in the server-side callback.
            nonce: gp_strategies_plugin_notice.nonce // Security nonce for the request.
        } );
